/*
 	   ...
 	   ||| Easyino_Robot - Education Official Sketch |||
 	    \\\\\\\\\\\\\\\\\\|||////////////////////
  Easyino_Robot.h - Library for using our inboard components in the best way
  Created by Federico Longhin, Mattia Pilotto, Edoardo Baggio 03 April, 2020.
  Manteined by Federico Longhin & Mattia Pilotto.
  V 0.3
*/

#ifndef Easyino_Robot_h
#define Easyino_Robot_h
...
const byte Easyino_Robot_firmware_referenceV1_0[] PROGMEM = {
...
// Version 2.0 (0x92)
// NXP Semiconductors; Rev. 3.8 - 17 September 2014; 16.1.1 Self test
const byte Easyino_Robot_firmware_referenceV2_0[] PROGMEM = {
...
class Easyino_Robot {
  ...
  bool isTaratura = false;
    ...
    // Easyino_Robot commands. Described in chapter 10 of the datasheet.
    enum PCD_Command {
      ...
      PCD_SoftReset			= 0x0F		// resets the Easyino_Robot
    };

    // Easyino_Robot RxGain[2:0] masks, defines the receiver's signal voltage gain factor (on the PCD).
    // Described in 9.3.3.6 / table 98 of the datasheet at http://www.nxp.com/documents/data_sheet/Easyino_Robot.pdf
    enum PCD_RxGain {
    ...
    // Size of the Easyino_Robot FIFO
    static const byte FIFO_SIZE = 64;		// The FIFO is 64 bytes.

    /////////////////////////////////////////////////////////////////////////////////////
    // Functions for setting up the Arduino
    /////////////////////////////////////////////////////////////////////////////////////
    Easyino_Robot(int rn);
    //Easyino_Robot(byte chipSelectPin, byte resetPowerDownPin);
